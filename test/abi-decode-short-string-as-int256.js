...
var abiDecodeShortStringAsInt256 = require("../src/abi-decode-short-string-as-int256");

describe("int256-short string conversions", function () {
  var test = function (t) {
    it(t.encodedAsInt256 + " <-> " + t.shortString, function () {
      assert.strictEqual(t.shortString, abiDecodeShortStringAsInt256(t.encodedAsInt256));
    });
  };
  test({
    shortString: "george",
