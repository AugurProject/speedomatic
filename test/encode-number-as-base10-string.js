...
var encodeNumberAsBase10String = require("../src/encode-number-as-base10-string");

describe("encodeNumberAsBase10String", function () {
  var test = function (t) {
    it(t.input + " -> " + t.expected, function () {
      var actual = encodeNumberAsBase10String(t.input);
